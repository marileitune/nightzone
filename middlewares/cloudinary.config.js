...
// the three cloudinary keys will be passed here from your .env file
cloudinary.config({
...
const storage = new CloudinaryStorage({
  cloudinary,
  folder: 'nightzone', // The name of the folder in cloudinary . You can name this whatever you want
